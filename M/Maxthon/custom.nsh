...
${Segment.OnInit}
	StrCpy $2 "7.3.1.6200" ;Maxthon Version
	...
	${If} $1 != 0
		...
		Rename "$EXEDIR\App\Maxthon$1\$2\PrivacySandboxAttestationsPreloaded" "$EXEDIR\App\Maxthon\$2\PrivacySandboxAttestationsPreloaded"
